...
class ArgumentsBase(object):
    def __init__(self):
        ...
        parser = self.parser
        parser.add_argument('-ddir', '--datadir', default="E:\\dataset\\safe-campus",
        ...
        parser.add_argument('-vs', '--version', type=str, default='train-all_duke-large-input_warm-up-v1_adam_triplet_label-smooth_erasing_test-bnneck-flips',
