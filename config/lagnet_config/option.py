...
parser = argparse.ArgumentParser(description='LAG')
...
parser.add_argument('--model', default='LAG', help='model name')
# parser.add_argument('--loss', type=str, default='1*CrossEntropy+1*Triplet', help='loss function configuration')
parser.add_argument('--loss', type=str, default='1*CrossEntropy+2*Triplet+1*L2', help='loss function configuration')
parser.add_argument('--apex', type=str, default='no', help='use fp16')
...
parser.add_argument('--num_classes', type=int, default=1175, help='')
parser.add_argument('--num_attentions', type=int, default=24, help='')
parser.add_argument('--num_features', type=int, default=2048, help='')
parser.add_argument('--L2_beta', type=float, default=5e-2, help='L2 beta2')
...
parser.add_argument('--amsgrad', action='store_true', default=True, help='ADAM amsgrad')
...
parser.add_argument('--decay_type', type=str, default='step_320_380_420', help='learning rate decay type')
parser.add_argument('--lr_decay', type=int, default=60, help='learning rate decay per N epochs')
parser.add_argument("--EPSILON", type=float, default=1e-2, help='learning rate')

parser.add_argument("--margin", type=float, default=1.2, help='')
parser.add_argument("--re_rank", action='store_true', help='')
parser.add_argument("--random_erasing", action='store_true', default=True,help='')
