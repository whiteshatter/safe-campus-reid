...
def resnet50(num_classes):
    return Baseline(num_classes, 1, 'static/modelzoo/resnet50-19c8e357.pth', 'bnneck', 'after', 'resnet50', 'imagenet')
...
def resnet50_ibn_a(num_classes):
    return Baseline(num_classes, 1, 'static/modelzoo/resnet50_ibn_a-d9d0bb7b.pth', 'bnneck', 'after', 'resnet50_ibn_a', 'imagenet')
