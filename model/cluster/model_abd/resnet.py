# from https://github.com/VITA-Group/ABD-Net
...
model_urls = {
    'resnet50': '../modelzoo/resnet50-19c8e357.pth',
}
...
def init_pretrained_weights(model, model_path):
    ...
    print('Initialized model with pretrained weights from {}'.format(model_path))
...
def resnet50(num_classes, args=dict(
    shallow_cam=True,
    compatibility=False,
    branches=('global', 'abd'),
